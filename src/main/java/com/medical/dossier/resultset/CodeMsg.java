package com.medical.dossier.resultset;
...
public class CodeMsg {
    ...
    public static CodeMsg ACTIVATE_ERROR=new CodeMsg(500102,"激活失败");
    // 业务异常
    ...
    public static CodeMsg NOT_FIND_DATA = new CodeMsg(500105,"账号密码错误");
    public static CodeMsg UPDATE_ERROR= new CodeMsg(500105,"信息更新失败");
    public static CodeMsg fail= new CodeMsg(500105,"操作失败");
